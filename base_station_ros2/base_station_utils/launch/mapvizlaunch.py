...
def generate_launch_description():
    base_params_path = (
        "/home/frostlab/base_station/base-station-ros2/base_station_params.yaml"
    )
    ...
    arg = DeclareLaunchArgument(
        "config", default_value=CONFIG_PATH, description="Path to a Mapviz config file."
    )
    launch_actions.extend(
        [  # use period if needed
