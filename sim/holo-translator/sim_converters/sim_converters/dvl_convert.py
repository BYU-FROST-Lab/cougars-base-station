...
class DVLReverse(Node):
    ...
    def __init__(self):
        ...
        self.DVL_publisher_ = self.create_publisher(
            DVL, frost_vehicle + "/dvl/data", 10
        )
        self.DVLDR_publisher_ = self.create_publisher(
            DVLDR, frost_vehicle + "/dvl/position", 10
        )
        ...
        self.DVLdead_reckon_subscription = self.create_subscription(
            PoseWithCovarianceStamped, "/holoocean/dead_reckon", self.DR_callback, 10
        )
